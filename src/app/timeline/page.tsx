  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 md:px-6 lg:px-8">
      <SectionHeading
        ...
        description="Mỗi mốc nay đã có lớp diễn giải sâu hơn, ảnh thật trích từ file Word và nguồn kiểm chứng để nối trực tiếp với bảo tàng 3D, kho ảnh/video và hồ sơ chiến dịch."
      />
